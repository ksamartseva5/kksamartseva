    ...
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            mainForm.AddFilter(new PixelFilter<RangeIncreacsingParameters>(
                ...
                (pixel, parameters) =>
                {
                    if (parameters.LowLevel > parameters.HighLevel)
                        throw new ArgumentException("Неверное значение каналов! Нижний канал должен быть меньше верхнего");
